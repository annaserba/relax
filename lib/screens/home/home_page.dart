...
import 'package:relax/model/playing_sounds.dart';
import 'package:relax/screens/details/category_details_page.dart';
import 'package:relax/screens/home/play_button.dart';
import 'package:relax/screens/home/playing_sound_view.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Container(
          ...
          decoration: BoxDecoration(color: Color(0xFF261E1E)),
          child: Stack(
  ...
  Widget showCategories() {
    return BlocBuilder<CategoryBloc, Result>(buildWhen: (previousState, state) {
  ...
  Widget categoryView(Category category) {
    return animation.OpenContainer(
      transitionType: animation.ContainerTransitionType.fade,
